...
namespace BqApi.Migrations
{
    ...
    [Migration("20241221222325_AddUserCreateTimeTracking")]
    partial class AddUserCreateTimeTracking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeautyQueenApi.Models.User", b =>
                {
                    ...
                    b.HasOne("BeautyQueenApi.Models.Promo", "InvitePromo")
                        .WithMany("InvitePromoUsers")
                        .HasForeignKey("InvitePromoId");

                    b.HasOne("BeautyQueenApi.Models.User", "Inviter")
